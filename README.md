...
Exploratory Data Analysis (EDA) – Uncovers patterns and user behavior trends.
Clustering Model – Groups consumers into meaningful segments.
Visual Insights – Uses graphs and charts to interpret results clearly.
Deployed Web App – Interactive interface to upload and analyze data.
